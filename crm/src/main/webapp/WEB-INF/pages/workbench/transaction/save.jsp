...
$(function () {
	...
	$("#create-transactionStage").on("change",function () {
		var selectedOption=$("#create-transactionStage").find("Option:selected").text();
		...
		$.ajax({
			...
			data:{"stageValue":selectedOption},
			type:"post",
			dataType:"json",
...
<body>
	...
	<form class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="hidden" id="create-activityId" value="dcd54296dc7441e5926c1c7cffd5f713">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="hidden" id="create-contactsId" value="a2e5f61942db4d41987c72deb32c8d18">
